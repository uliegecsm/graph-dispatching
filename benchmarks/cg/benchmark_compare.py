...
class CGBenchmark(BenchmarkBase):
    ...
    def analyse(self) -> None:
        ...
        fig, convergence_axes = matplotlib.pyplot.subplots(nrows = 2, ncols = 1, figsize = (10, 7))
        ...
        for ext in ('png', 'svg', 'eps'):
            ...
            fig.savefig(output, bbox_inches = 0, transparent = False)
        
        matplot2tikz.save(figure=fig, filepath=self.results[CollectionMethod.CONVERGENCE].with_suffix('.tex').resolve())
