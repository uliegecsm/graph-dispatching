 ...
 *
 * Conjugate gradient solver with a @c Kokkos::Graph with host pinned variables
 * ----------------------------------------------------------------------------
 *
 * Similar to @ref tests/cg/test_outlook.cpp, but using pinned host variables instead of @c Kokkos::deep_copy.
 *
 * The test can be found in @ref cg/test_outlook.pinned.cpp.
 */
