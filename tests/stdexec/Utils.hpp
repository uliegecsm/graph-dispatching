...
struct CheckSchedulerSender
{
    ...
    get_completion_signatures(Env&&...) -> _completion_signatures<CheckSchedulerSender, Env...> { return {}; } // NOLINT(cppcoreguidelines-missing-std-forward)
...
//! Default scheduler when no specific one is used.
