...
#define DO_PRAGMA_(x) _Pragma (#x)
    ...
    #define PRAGMA_DIAGNOSTIC_IGNORED(what) DO_PRAGMA_(clang diagnostic ignored what) // NOLINT(cppcoreguidelines-macro-usage)
...
#if defined(__clang__)
    #define PRAGMA_DIAGNOSTIC_IGNORED_DEPRECATED_ATTRIBUTES PRAGMA_DIAGNOSTIC_IGNORED("-Wdeprecated-attributes")
#else
    #define PRAGMA_DIAGNOSTIC_IGNORED_DEPRECATED_ATTRIBUTES
#endif
