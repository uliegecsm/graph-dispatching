...
TEST_F(ContinuesOnTest, queryable_get_exec) {
    ...
    static_assert(std::same_as<
                  ...
                  ::stdexec::__env::__fwd<::stdexec::__env::env<
                      ::stdexec::__env::prop<
                          Kokkos::Experimental::details::execution_space::get_exec_t,
                          Kokkos::Experimental::details::execution_space::ExecutionSpaceRef<host_execution_space>
                      >,
                      ::stdexec::__env::__fwd<Kokkos::Experimental::details::impl::env>
                  >>
    >);

    //! Our customization of @c continuous_on forwards the environment.
    ...
    >);
    std::cout << "*************************************" << std::endl;
    Kokkos::Experimental::details::execution_space::ExecutionSpaceRef<Kokkos::OpenMP>{exec_h}.get();
    std::cout << "*************************************" << std::endl;
    ASSERT_EQ(
    ...
    //! update this The @ref Kokkos::Experimental::details::execution_space::get_exec_t query is forwarded from downstream to upstream.
