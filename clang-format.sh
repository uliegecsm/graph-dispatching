...
PATTERNS=(
    ...
    'tests/newton/*.cpp'
    'tests/newton/*.hpp'
    'tests/nvexec/adaptors/test_on.cpp'
    'tests/nvexec/adaptors/test_when_all.cpp'
    'tests/stdexec/adaptors/test_let_value.cpp'
    'tests/stdexec/adaptors/test_on.cpp'
    'tests/stdexec/adaptors/test_split.cpp'
    'tests/stdexec/adaptors/test_when_all.cpp'
    'tests/stdexec/queries/test_domain.cpp'
    'tests/utils/*'
